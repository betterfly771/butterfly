(function (global, factory) {
    ...
    function invoke(pendings = [], eventArgs) {
      ...
      appChangesUnderway = true; // 这里是整个SingleSpa的状态， 判断容器应用是否启动
      ...
      function performAppChanges() {
        ...
        unmountPromise = Promise.all(unmountPromise); // will load app --> NOT_MOUNTED
        ...
        let mountApps = getAppsTomount(); // 针对load和mount的app做去重， 这里看一下， 为什么要去重
      ...
      function finish() {
        ...
        let returnValue = getMountedApps(); // 将当前进程中的所有状态置为成功
